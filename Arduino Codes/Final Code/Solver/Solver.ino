/*creator: swapnilsingh98*/
/*implements the Layer-Wise method to solve a 3×3×3 Rubik’s Cube*/
/*we used this code with L298N stepper motor drivers*/  
...
void setup() {
  /*set the speed of the stepper. if you want the speed to be high(it can go upto 200 revolutions per minute),
    you will have to add codes for acceleration and deceleration of steppers*/
...
/*enter the individual faces of the cube manually/serial communication in the order proided in the image "ordered_Colours"*/
...
void swap(char &a,char &b)/*function swaps two elements of an array*/
{
    char t=a;
    a=b;
    b=t;
}
void rotate_clock(char choice)/*rotation of steppers of each face and corresponding color swaps to be performed. This ensures that the entire cube is solved only using the initial state of the faces. No further input is required in between*/ 
{
  if (choice=='w')
  {
...
void white_bottom(char q) /*for bottom of the white face*/
{
