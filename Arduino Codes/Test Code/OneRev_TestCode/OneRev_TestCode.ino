/*creator: abhinavchaudhary*/

/*test code to run the stepper motors with L298N after completion of assembly*/
...
void loop(){
  /*simply runs the steppers one by one for 90 degrees with 0.5 second delay in loop for */
